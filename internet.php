...
<section class="flex >
   ...
   <div class="box-container">
      ...
      <div class="boxin">
         ...
         <p class="tutor"> The internet is like a giant web of computers connected through cables, satellites, and wireless signals. Every time you click a link or send a message, data travels through this network at lightning speed to deliver the information you need.</p>
         <a href="internet.php" class="inline-btn">Previous</a>  	<a href="binary.php" class="inline-btn">Next</a> 
      </div>
