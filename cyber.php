...
<section class="flex >
   ...
   <div class="box-container">
      ...
      <div class="boxin">
         <h1 class="title">Cybersecurity Basics </h1>
         <p class="tutor"> The first computer virus, called "Creeper," was created in the 1970s, but it was harmless and just displayed a message. Today, cybersecurity is crucial to protect against millions of cyber threats worldwide!
</p>
          <a href="binary.php" class="inline-btn">Previous</a> <a href="wire.php" class="inline-btn">Next</a> 
      </div>
